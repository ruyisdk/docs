import{_ as n,c as a,ag as p,o as l}from"./chunks/framework.Bie0PW65.js";const i="/docs/assets/1736822816333.dcy88Uvm.png",e="/docs/assets/1736822773688.Dl_DMl9y.png",h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"zh/milkv-duo/5-ruyisdk-plctgnu.md","filePath":"zh/milkv-duo/5-ruyisdk-plctgnu.md","lastUpdated":1737610063000}'),t={name:"zh/milkv-duo/5-ruyisdk-plctgnu.md"};function c(o,s,u,d,r,g){return l(),a("div",null,s[0]||(s[0]=[p(`<h2 id="使用-gnu-plct-为-milkv-duo-编译-验证" tabindex="-1">使用 gnu-plct 为 milkv duo 编译（验证） <a class="header-anchor" href="#使用-gnu-plct-为-milkv-duo-编译-验证" aria-label="Permalink to &quot;使用 gnu-plct 为 milkv duo 编译（验证）&quot;">​</a></h2><h3 id="调研-gnu-plct-是否能够支持-milkv-duo" tabindex="-1">调研 gnu-plct 是否能够支持 milkv duo <a class="header-anchor" href="#调研-gnu-plct-是否能够支持-milkv-duo" aria-label="Permalink to &quot;调研 gnu-plct 是否能够支持 milkv duo&quot;">​</a></h3><ul><li>milkv duo ：硬件扩展支持情况</li><li>milkv duo ：官方推荐的工具链情况</li><li>了解 gnu-plct （ 仓库地址：<a href="https://github.com/ruyisdk/riscv-gnu-toolchain" target="_blank" rel="noreferrer">https://github.com/ruyisdk/riscv-gnu-toolchain</a> ）当前指令集支持情况： <ul><li>gnu-plct指令集支持情况历史文档：<a href="https://github.com/ruyisdk/docs/blob/f7871dfaf735d84fa61552c10c700afd1b278391/docs/zh/sdk/gnu/index.md" target="_blank" rel="noreferrer">https://github.com/ruyisdk/docs/blob/f7871dfaf735d84fa61552c10c700afd1b278391/docs/zh/sdk/gnu/index.md</a></li></ul></li></ul><h3 id="安装编译器-编译" tabindex="-1">安装编译器，编译 <a class="header-anchor" href="#安装编译器-编译" aria-label="Permalink to &quot;安装编译器，编译&quot;">​</a></h3><ol start="2"><li><p>安装 gnu-plct 编译器</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#查看软件源的资源</span></span>
