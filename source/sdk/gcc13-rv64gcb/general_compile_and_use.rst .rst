...
支持Bitmanip扩展RISCV-GNU-Toolchain的编译和使用 
################################
...
.. tabs:: 
   ...
   .. code-tab:: 64位支持Bitmanip扩展的构建（rv64gc_zba_zbb_zbc_zbs）
...
.. toctree::
   ...
   _gcc13-rv64gcb/general_compile_and_use.rst